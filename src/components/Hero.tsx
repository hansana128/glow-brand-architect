  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 opacity-30">
        <div className="absolute top-20 left-20 w-72 h-72 rounded-full bg-brand-orange/20 blur-[80px]"></div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col items-start text-left">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-wide">
              ...
              <span className="text-brand-orange">HEADS.</span>
              <br />
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute top-0 -right-4 w-8 h-8 bg-brand-orange rounded-full animate-pulse"></div>
