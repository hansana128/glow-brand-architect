...
const Carousel = () => {
  return <section className="bg-brand-blue/50 overflow-hidden py-[18px] my-0 px-0 rounded-sm">
      <div className="marquee-container relative whitespace-nowrap">
        <div className="flex animate-marquee">
          {/* Duplicate the content to create seamless looping */}
          {Array(2).fill(0).map((_, index) => <div key={index} className="flex items-center gap-4 mx-4">
